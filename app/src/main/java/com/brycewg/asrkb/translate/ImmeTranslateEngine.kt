...
class ImmeTranslateEngine(
    ...
    companion object {
        private const val TAG = "ImmeTranslateEngine"
        private const val DEFAULT_ENDPOINT = "https://api.imme.ai/translate"
    }
    ...
    private fun parseTranslateResponse(body: String, targetLang: String): TranslateResult {
        return try {
            ...
            val detectedLang = json.optString("detected_lang", null)
